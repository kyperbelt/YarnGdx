...
/**
 * Allows loading of dialogues via AssetManager. Note that the dialogue instance is kept the same through loading
 * calls.
 *
 * @see AssetManager
 */
public class DialogueAssetLoader extends AsynchronousAssetLoader<Dialogue, DialogueAssetLoader.DialogParameter> {
  ...
  public Array<AssetDescriptor> getDependencies(String fileName, FileHandle file,
                                                DialogueAssetLoader.DialogParameter parameter){
    return null;
  }
