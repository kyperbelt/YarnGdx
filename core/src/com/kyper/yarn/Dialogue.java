...
public class Dialogue {
	 ...
	 */
	public void loadString(String text, String fileName, boolean showTokens, boolean showTree,
			String onlyConsider) {
		if (debugLogger == null) {
	 ...
	 *            loading;all else will be ignored.
	 */
	public void loadFile(String file, boolean showTokens, boolean showTree, String onlyConsider) {
		String input = Gdx.files.internal(file).readString();

		loadString(input, file, showTokens, showTree, onlyConsider);
	}
	 ...
	 *            loading;all else will be ignored.
	 */
	public void loadFile(String file, String onlyConsider) {
		loadFile(file, false, false, onlyConsider);
	}
	...
	public ObjectMap<String, String> getTextForAllNodes() {
		if (textForNodes == null)
			textForNodes = new ObjectMap<String, String>();
		textForNodes.clear();
	...
	protected ReturningFunc yarnFunctionNodeVisitCount = new ReturningFunc() {
		...
		public Object invoke(Value... params) {
			...
			int visitCount = 0;
			if (visitedNodeCount.containsKey(nodeName))
				visitCount = visitedNodeCount.get(nodeName);
			return visitCount;
		}
	};
